    ...
    Body: ({ p }) => (
      <ol className="manual-steps">
        ...
        <li className="manual-step">
          ...
          <ul>
            <li><b>พิมพ์ใบขออนุมัติ OT ทุกคน</b> — รวมใบของ<b>ทุกคนที่อยู่บนตารางตอนนั้น</b>เป็นเอกสารเดียว หนึ่งคนต่อหนึ่งหน้า · ค้นหาไว้เท่าไร ได้ออกมาเท่านั้น</li>
            <li><b>ส่งออกรายการ OT (CSV)</b> — หนึ่งบรรทัดต่อหนึ่งใบ</li>
            <li><b>ส่งออกรายงานสรุปประจำเดือน (CSV)</b> — หนึ่งบรรทัดต่อหนึ่งคน</li>
          </ul>
          <Shot
            alt="ปุ่มพิมพ์ส่งออกบนหัวการ์ด กดแล้วเปิดเป็นรายการสามบรรทัด บรรทัดแรกคือพิมพ์ใบขออนุมัติ OT ทุกคน แล้วส่งออกรายการ OT และส่งออกรายงานสรุปประจำเดือน แต่ละบรรทัดมีคำอธิบายกำกับ"
            ...
            desk={(
              <Desk title="ตรวจสอบประจำเดือน" nav={<MkRow on>ตรวจสอบประจำเดือน</MkRow>}>
                ...
                <span className="mk-col">
                  <MkRow>พิมพ์ใบขออนุมัติ OT ทุกคน</MkRow>
                  <MkNote>รวมทุกคนในตาราง หนึ่งคนต่อหนึ่งหน้า · F-HR-027</MkNote>
                  <MkRow>ส่งออกรายการ OT (CSV)</MkRow>
                  <MkRow>ส่งออกรายงานสรุปประจำเดือน (CSV)</MkRow>
                </span>
        ...
        <li className="manual-step">
          ...
          <Shot
            alt="หน้ารายงาน OT การเงิน เลือกบริษัทและเดือนได้ ตารางเรียงตามแผนกพร้อมรวมแผนกและรวมทั้งหมด ปุ่มพิมพ์ส่งออกบนหัวการ์ดเปิดเป็นสองบรรทัดคือส่งออกไฟล์บัญชีและพิมพ์แบบฟอร์ม"
            ...
            desk={(
              <Desk title="รายงาน OT การเงิน" nav={<MkRow on>รายงาน OT การเงิน</MkRow>}>
                ...
                <span className="mk-acts"><MkBtn>พิมพ์ / ส่งออก ▾</MkBtn></span>
                <span className="mk-col">
                  <MkRow>ส่งออกไฟล์บัญชี (CSV/Excel)</MkRow>
                  <MkNote>หนึ่งบรรทัดต่อหนึ่งคน · เป็นชั่วโมง ไม่มีการคำนวณเป็นเงิน</MkNote>
                  <MkRow>พิมพ์แบบฟอร์ม / บันทึกเป็น PDF</MkRow>
                </span>
    ...
    Body: () => (
      <ol className="manual-steps">
        <li className="manual-step">
          ...
          <Shot
            alt="หน้ารายงาน OT แยกแผนก เลือกแผนกและเดือนได้ ตารางเรียงเป็นลำดับที่ ชื่อ บริษัท และรวมชั่วโมง ปุ่มพิมพ์ส่งออกบนหัวการ์ดเปิดเป็นสองบรรทัดคือส่งออกไฟล์แยกแผนกและพิมพ์แบบฟอร์ม"
            ...
            desk={(
              <Desk title="รายงาน OT แยกแผนก" nav={<MkRow on>รายงาน OT แยกแผนก</MkRow>}>
                ...
                <span className="mk-acts"><MkBtn>พิมพ์ / ส่งออก ▾</MkBtn></span>
                <span className="mk-col">
                  <MkRow>ส่งออกไฟล์แยกแผนก (CSV/Excel)</MkRow>
                  <MkNote>ครบทุกแผนก ไม่ขึ้นกับแผนกที่เลือก · เป็นชั่วโมง ไม่ใช่เงิน</MkNote>
                  <MkRow>พิมพ์แบบฟอร์ม / บันทึกเป็น PDF</MkRow>
                </span>
    ...
    Body: () => (
      <ol className="manual-steps">
        ...
        <li className="manual-step">
          ...
          <Shot
            alt="ทางพิมพ์ใบใหม่หลังแก้ไข ปุ่มพิมพ์ F-HR-027 ท้ายแถวของคนนั้น หรือเลือกพิมพ์ใบขออนุมัติ OT ทุกคนในเมนูพิมพ์ส่งออกเมื่อจะพิมพ์ทั้งเดือนอีกครั้ง"
            ...
            desk={(
              <Desk title="ตรวจสอบประจำเดือน" nav={<MkRow on>ตรวจสอบประจำเดือน</MkRow>}>
                ...
                <MkNote>ทั้งเดือนอีกครั้ง — พิมพ์ / ส่งออก ▾ → พิมพ์ใบขออนุมัติ OT ทุกคน</MkNote>
              </Desk>
            )}
            phone={(
              <Phone title="ตรวจสอบประจำเดือน" bar={<MkSlot icon="chart" label="รายงาน" on />}>
