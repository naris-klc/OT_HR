 ...
 *
 * ⚠ AND THAT RULE WAS MISSED FOR FOUR DAYS RUNNING, 2026-09-10 to 2026-09-14 —
 * six controls renamed or removed under drawings that went on showing the old
 * one, none of it failing anything. `test/manualScreen.test.js` now reads the
 * screens and the drawings TOGETHER for the ones that are mechanical: the rows
 * inside each `<ExportMenu>`, `openRowLabel`'s two names, `verb` on the queue,
 * and the rail button's own text. It cannot tell whether a drawing is a GOOD
 * picture of a screen; that is still the walk, and the walk is still the rule.
 *
...
const SECTIONS = [
      ...
      <ol className="manual-steps">
        ...
        <li className="manual-step">
          ...
          <ul>
            ...
            <li><b>ปุ่มย้อนกลับของเบราว์เซอร์ และการปัดกลับบนมือถือ ถอยทางเดียวกับโลโก้</b> — ปิดสิ่งที่เปิดทับอยู่ก่อน แล้วจึงถอยหน้าจอ ไม่ได้หลุดออกจากแอป</li>
            <li><b>กด reload แล้วยังอยู่หน้าจอเดิม</b> — ชื่อหน้าจอที่เปิดอยู่ถูกเก็บไว้ท้าย URL · ส่วนเดือนที่เลือกและตัวกรองไม่ได้อยู่ในนั้น โหลดใหม่แล้วสองอย่างนี้เริ่มใหม่</li>
            <li>บนคอมพิวเตอร์ <b>ปุ่มรูปแผงเมนูข้าง PRIMUS หัวแถบซ้าย</b>พับแถบให้เหลือเฉพาะไอคอน · ชี้ค้างที่ไอคอนแล้วชื่อเต็มจะขึ้นมา · หน้าต่างแคบระบบพับให้เอง กดปุ่มนี้เพื่อกางค้างไว้ได้</li>
          ...
          <Shot
            alt="สิ่งที่อยู่บนแถบเมนู บนคอมพิวเตอร์คือหัวแถบ PRIMUS พร้อมปุ่มรูปแผงเมนูสำหรับพับแถบ หัวข้อบล็อก แถวหน้าจอพร้อมตัวเลขสีเหลือง และชื่อตัวเองที่ก้นแถบ บนมือถือคือโลโก้ย้อนกลับมุมบนซ้าย ปุ่มตัวอักษรย่อมุมบนขวา และแถบล่างที่มีตัวเลขบนปุ่ม"
            ...
            desk={(
              ...
              >
                <MkNote>ปุ่มรูปแผงเมนูที่หัวแถบพับทั้งแถบให้เหลือเฉพาะไอคอน · ชี้ค้างแล้วชื่อเต็มจะขึ้นมา</MkNote>
              </Desk>
            )}
            phone={(
              <Phone
        ...
        <li className="manual-step">
          ...
          <Shot
            alt="หน้าคู่มือที่คุณกำลังอ่านอยู่ บนคอมพิวเตอร์รายชื่อหัวข้อเป็นแถบอยู่ข้างซ้ายของเนื้อหา บนมือถือเป็นปุ่ม ไปที่หัวข้อ ที่กดแล้วรายชื่อเดียวกันกางลงมา"
            caption="รายการหัวข้อไม่ใช่หน้าแยก — เนื้อหาทั้งหมดอยู่หน้าเดียวเลื่อนอ่านต่อกันได้ กดหัวข้อคือการกระโดดไปที่จุดนั้น ไม่ต้องกดย้อนกลับ · ตัวเลขบนปุ่มคือจำนวนหัวข้อในฉบับของคุณเอง ซึ่งแต่ละบทบาทไม่เท่ากัน"
            desk={(
            ...
            phone={(
              <Phone title="คู่มือการใช้งาน" bar={<MkSlot icon="sliders" label="เพิ่มเติม" />}>
                <span className="mk-headrow">
                  <MkRow>ไปที่หัวข้อ</MkRow>
                  <span className="mk-acts"><MkNote>8 หัวข้อ ▾</MkNote></span>
                </span>
                <span className="mk-col">
                  <span className="mk-side-h">อ่านก่อนใช้งาน</span>
                  <MkRow on>เริ่มต้นใช้งาน</MkRow>
                ...
                <MkNote>กดปุ่มนี้แล้วรายชื่อกางลงมา · เลือกหัวข้อแล้วรายชื่อหุบเอง</MkNote>
              </Phone>
            )}
          />
        </li>
          ...
          <div className="manual-table-wrap">
            <table className="manual-table">
              <tbody>
                ...
                {/* ── งวดปิดเอง — THE FOURTH ROW IS NOT A STATUS ────────────
                    The three above are what the entry IS; this one is what the
                    calendar has done to it, and it can happen to any of them.
                    On the same table anyway, because the question somebody
                    opens this page with is "ยื่นผิดแล้วทำอย่างไร" and this is
                    one of the answers they can get. */}
                <tr>
                  <td className="nowrap"><MkChip tone="no">หมดเวลาแก้ไข</MkChip></td>
                  <td>
                    <b>เลยวันตัดของงวดแล้ว</b> — ฝ่ายบุคคลอาจตั้งไว้ว่าใบของเดือนหนึ่ง
                    แก้ไข ยกเลิก หรือถอนได้ถึงวันที่เท่าไรของเดือนถัดไป พ้นวันนั้นแล้ว
                    ปุ่มทั้งสามจะหายไปจากแถว และขึ้นคำว่า <b>หมดเวลาแก้ไข</b> แทน ·
                    เอาเมาส์ชี้ที่คำนั้นจะบอกว่างวดไหนและกำหนดสุดท้ายวันที่เท่าไร ·
                    <b>ติดต่อฝ่ายบุคคลให้ดำเนินการแทนได้</b> ฝ่ายบุคคลไม่ติดกำหนดนี้ ·
                    ถ้าฝ่ายบุคคลยังไม่ได้ตั้งค่านี้ไว้ จะไม่มีกำหนดอะไรทั้งสิ้น
                  </td>
                </tr>
              </tbody>
            </table>
...

  {
    ...
    Body: () => (
      <ol className="manual-steps">
        ...
        <li className="manual-step">
          <p>สองปุ่มเหนือกระดาษทำคนละอย่าง และวิธีตั้งหน้ากระดาษอยู่หลังปุ่มที่สามในแถวเดียวกัน</p>
          <ul>
            ...
            <li><b>วิธีพิมพ์ ▼</b> — กดแล้วการ์ดวิธีตั้งหน้ากระดาษกางออกมาใต้แถวปุ่ม: <b>A4 แนวตั้ง</b> ขอบกระดาษ “เริ่มต้น” · และ<b>ติ๊กเปิด “กราฟิกพื้นหลัง”</b> เพื่อให้แถบสีเหลืองบนใบติดไปด้วย · กดอีกทีพับกลับ และมันเริ่มที่พับไว้ทุกครั้ง กระดาษจะได้ขึ้นมาเต็มจอ</li>
          </ul>
          <Shot
            alt="แถบปุ่มเหนือกระดาษ ปุ่มพิมพ์ ปุ่มบันทึกเป็น PDF และปุ่มวิธีพิมพ์ที่กางการ์ดวิธีตั้งหน้ากระดาษออกมาใต้แถว บนมือถือปุ่มเรียงเต็มความกว้างและการ์ดกางอยู่ใต้ลงมา"
            caption="แถบนี้เป็นของหน้าพิมพ์เอง ไม่ต้องจำ — หน้าที่พิมพ์ได้ทุกหน้าในระบบมีแถบเดียวกันนี้ และการ์ดวิธีพิมพ์ก็พับอยู่ที่เดิมทุกหน้า"
            desk={(
              <Desk title="พิมพ์ใบขออนุมัติ OT" nav={<MkRow on>พิมพ์ใบขออนุมัติ OT</MkRow>}>
                <span className="mk-acts">
                  <MkBtn>พิมพ์</MkBtn>
                  <MkBtn>บันทึกเป็น PDF</MkBtn>
                  <MkBtn ghost>วิธีพิมพ์ ▼</MkBtn>
                </span>
      ...
      <ol className="manual-steps">
        <li className="manual-step">
          ...
          <ul>
            ...
            <li>
              เหนือตารางเป็น<b>แถบตัวกรอง</b> — ช่อง <b>ค้นหา</b> (ชื่อ · รหัสพนักงาน · รายละเอียดงาน)
              {' '}แล้ว <b>แผนก</b> และ <b>เดือน</b> · บางบทบาทมีช่อง <b>บทบาท</b> เพิ่มมาด้วย
              {' '}ปุ่ม <b>ล้างตัวกรอง</b> ขึ้นมาเมื่อมีช่องไหนถูกใช้อยู่ · แถบนี้อยู่ที่เดิมเสมอแม้คิวจะว่าง
            </li>
            <li>
              คิวยาว<b>แบ่งหน้า</b> — แถบใต้ตารางบอกว่ากำลังดูช่วงไหนจากทั้งหมดกี่รายการ และเลือกจำนวนต่อหน้าได้
              {' '}· <b>ติ๊กไว้แล้วเปลี่ยนหน้า ที่ติ๊กไม่หลุด</b> แต่พิมพ์ในช่องค้นหาใหม่จะล้างที่ติ๊กทั้งหมด
            </li>
          </ul>
          <Shot
        ...
        <li className="manual-step">
          ...
          <p className="hint">
            แถวแบบนี้<b>ไม่ได้หายไปจากคิว</b> และไม่ได้เหลือช่องว่างท้ายแถว — ตรงที่ปุ่มเคยอยู่จะเป็น
            {' '}<b>ขีด —</b> ชี้ค้างแล้วมีคำอธิบายขึ้นมาว่าทำไมแถวนี้ไม่ใช่ของคุณ ·
            {' '}บนมือถือประโยคนั้นเขียนอยู่บนการ์ดตรง ๆ ไม่ต้องชี้
          </p>
          <Shot
            alt="แถวที่คุณกดปุ่มไม่ได้ แถวที่คุณเป็นผู้บันทึกเองขึ้นข้อความว่าต้องให้คนอื่นเป็นผู้อนุมัติ และแถวที่ไม่ใช่ใบที่คุณเซ็นขึ้นข้อความว่าดูได้อย่างเดียว ท้ายแถวทั้งสองเป็นขีดแทนปุ่มถูกและกากบาท"
            caption="แถวแบบนี้ยังอยู่ในคิวและเปิดอ่านได้ — สิ่งที่เปลี่ยนคือปุ่มกลายเป็นขีดที่ถือคำอธิบายไว้ ไม่ใช่ทั้งแถวหายไป"
            desk={(
              <Desk title="รายการรออนุมัติ" nav={<MkRow on badge="3">รายการรออนุมัติ</MkRow>}>
                <span className="mk-headrow">
                ...
                <span className="mk-headrow">
                  ...
                  <span className="mk-acts"><MkNote>—</MkNote></span>
                </span>
      ...
      <ol className="manual-steps">
        ...
        <li className="manual-step">
          ...
          <ul>
            ...
            <li>
              <b>กดที่แถว</b>เพื่อเปิดรายการ OT ของคนนั้นทั้งเดือน — ไม่มีปุ่มแยกท้ายแถวแล้ว
              {' '}ท้ายแถวเหลือปุ่มเดียวคือ<b>พิมพ์ใบ F-HR-027 ของคนนั้น</b> ซึ่งไม่ใช่การเปิดดู จึงไม่ถูกยุบเข้าไปกับแถว
            </li>
          </ul>
          <Shot
            alt="ตารางรายคนของทีม คอลัมน์เรียงเป็นชื่อพนักงาน แผนก ชั่วโมงสามช่องอัตรา รวม จำนวนรายการ และช่องสะสมทับเพดานของคนนั้น กดที่แถวเพื่อเปิดรายการของคนนั้น ท้ายแถวเป็นปุ่มพิมพ์ใบ F-HR-027"
            ...
            desk={(
              <Desk title="รายงาน OT ประจำทีม" nav={<MkRow on>รายงาน OT ประจำทีม</MkRow>}>
                ...
                <span className="mk-headrow">
                  <MkRow pin="›">ปรีชา ตั้งใจ · PM-0733</MkRow>
                  <span className="mk-acts">
      ...
      <ol className="manual-steps">
        {p.readOnly ? (
          <li className="manual-step">
            ...
            <Shot
              alt="แถวในตารางตรวจสอบประจำเดือนของบทบาทที่เปิดอ่านได้อย่างเดียว กดที่แถวเพื่อเปิดรายการของคนนั้นได้ ท้ายแถวมีปุ่มพิมพ์ปุ่มเดียว ไม่มีช่องติ๊กและไม่มีปุ่มยืนยัน และหน้าที่เปิดต่อไปก็ไม่มีปุ่มแก้ไขที่แถวใบ"
              ...
              desk={(
                <Desk title="ตรวจสอบประจำเดือน" nav={<MkRow on>ตรวจสอบประจำเดือน</MkRow>}>
                  <span className="mk-headrow">
                    <MkRow pin="›">สมชาย ใจดี · PM-0620</MkRow>
                    <span className="mk-acts"><MkIconBtn icon="printer" tone="off" /></span>
                  </span>
                  <MkNote>ฝ่ายบุคคลและผู้ดูแลระบบมีช่องติ๊กและปุ่มยืนยันเพิ่มมาในคอลัมน์เดียวกันนี้</MkNote>
                </Desk>
              )}
              phone={(
        ...
        <li className="manual-step">
          ...
          <Shot
            alt="ตารางตรวจสอบประจำเดือน หนึ่งแถวต่อพนักงานหนึ่งคน มีคอลัมน์แผนก ชั่วโมงสามช่องอัตรา รวม จำนวนรายการ คอลัมน์สแกน จำนวนครั้งที่แก้ไข และสะสมทับเพดาน หน้าแถวมีช่องติ๊ก และกดที่แถวเพื่อเปิดรายการของคนนั้น"
            caption="ตัวเลขในภาพเป็นตัวอย่าง — คอลัมน์ แก้ไข บอกว่าแถวนั้นเคยถูกแตะกี่ครั้ง กดแล้วดูได้ว่าใครแก้อะไรและค่าเดิมคืออะไร"
            desk={(
              <Desk title="ตรวจสอบประจำเดือน" nav={<MkRow on>ตรวจสอบประจำเดือน</MkRow>}>
                <MkCols>☐ · พนักงาน · แผนก · ×1.5 ปกติ · ×1.5 วันหยุด · ×3 วันหยุด · รวม ชม. · รายการ · สแกน · แก้ไข · สะสม / เพดาน</MkCols>
                <span className="mk-headrow">
                  <MkTick>สมชาย ใจดี · ฝ่ายผลิต</MkTick>
                  <span className="mk-acts">
        ...
        {p.readOnly ? null : (
          <li className="manual-step">
            ...
            <ul>
              <li>
                แถบนั้นบอกไว้ตั้งแต่ยังไม่ติ๊กว่า <b>ยืนยันได้กี่คน กี่รายการ</b> ·
        ...
        <li className="manual-step">
          <p>
            เอกสารของเดือนทั้งหมดอยู่หลังปุ่มเดียวบนหัวการ์ด — <b>พิมพ์ / ส่งออก ▾</b>
            {' '}กดแล้วเป็นรายการสามบรรทัด แต่ละบรรทัดมีคำอธิบายกำกับว่าได้อะไรออกมา
          </p>
          <ul>
            <li><b>พิมพ์ใบขออนุมัติ OT</b> — รวมใบของ<b>ทุกคนที่อยู่บนตารางตอนนั้น</b>เป็นเอกสารเดียว หน้าละคน · ค้นหาไว้เท่าไร ได้ออกมาเท่านั้น</li>
            <li><b>รายการ OT (CSV/Excel)</b> — บรรทัดละใบ</li>
            <li><b>สรุปรายเดือน (CSV/Excel)</b> — บรรทัดละคน</li>
          </ul>
          <Shot
            alt="ปุ่มพิมพ์ส่งออกบนหัวการ์ด กดแล้วเปิดเป็นรายการสามบรรทัด บรรทัดแรกคือพิมพ์ใบขออนุมัติ OT แล้วรายการ OT และสรุปรายเดือนซึ่งเป็นไฟล์ CSV/Excel แต่ละบรรทัดมีคำอธิบายกำกับ"
            caption="ปุ่มเดียวแทนปุ่มสามปุ่มที่เคยเรียงเป็นแถว — ใบที่พิมพ์ได้เท่ากับตารางที่เห็นอยู่ ส่วนไฟล์ CSV และยอด รวมทั้งหมด ยังเป็นของทั้งเดือน ไม่ใช่เฉพาะผลการค้นหา"
            desk={(
              <Desk title="ตรวจสอบประจำเดือน" nav={<MkRow on>ตรวจสอบประจำเดือน</MkRow>}>
                <span className="mk-headrow">
                  <MkField label="ค้นหาพนักงาน">ค้นหาชื่อ หรือ รหัสพนักงาน…</MkField>
                  <span className="mk-acts"><MkBtn>พิมพ์ / ส่งออก ▾</MkBtn></span>
                </span>
                <span className="mk-col">
                  <MkRow>พิมพ์ใบขออนุมัติ OT</MkRow>
                  <MkNote>ทุกคนในตาราง · หน้าละคน · F-HR-027</MkNote>
                  <MkRow>รายการ OT (CSV/Excel)</MkRow>
                  <MkRow>สรุปรายเดือน (CSV/Excel)</MkRow>
                </span>
        ...
        <li className="manual-step">
          <p><b>รายงาน OT การเงิน</b> — แผ่นที่ส่งการเงิน พิมพ์ออกไปได้ทั้งเดือน</p>
          <Shot
            alt="หน้ารายงาน OT การเงิน เลือกบริษัทและเดือนได้ ตารางเรียงตามแผนกพร้อมรวมแผนกและรวมทั้งหมด ปุ่มพิมพ์ส่งออกบนหัวการ์ดเปิดเป็นสองบรรทัดคือพิมพ์ใบสรุปส่งการเงินและไฟล์การเงิน"
            ...
            desk={(
              <Desk title="รายงาน OT การเงิน" nav={<MkRow on>รายงาน OT การเงิน</MkRow>}>
                ...
                <span className="mk-acts"><MkBtn>พิมพ์ / ส่งออก ▾</MkBtn></span>
                <span className="mk-col">
                  <MkRow>พิมพ์ใบสรุปส่งการเงิน</MkRow>
                  <MkNote>ตามบริษัทที่เลือก</MkNote>
                  <MkRow>ไฟล์การเงิน (CSV/Excel)</MkRow>
                  <MkNote>บรรทัดละคน · เป็นชั่วโมง ไม่ใช่เงิน</MkNote>
                </span>
      ...
      <ol className="manual-steps">
        <li className="manual-step">
          <p>
            ...
            ใบนี้ตอบว่า<b>แผนกไหนทำไปเท่าไร</b> ส่วนใบการเงินตอบว่า<b>ส่งการเงินเท่าไร</b>
          </p>
          <Shot
            alt="หน้ารายงาน OT แยกแผนก เลือกแผนกและเดือนได้ ตารางเรียงเป็นลำดับที่ ชื่อ บริษัท และรวมชั่วโมง ปุ่มพิมพ์ส่งออกบนหัวการ์ดเปิดเป็นสองบรรทัดคือพิมพ์ใบสรุปแยกแผนกและไฟล์แยกแผนก"
            ...
            desk={(
              <Desk title="รายงาน OT แยกแผนก" nav={<MkRow on>รายงาน OT แยกแผนก</MkRow>}>
                ...
                <span className="mk-acts"><MkBtn>พิมพ์ / ส่งออก ▾</MkBtn></span>
                <span className="mk-col">
                  <MkRow>พิมพ์ใบสรุปแยกแผนก</MkRow>
                  <MkNote>ครบทุกแผนก ไม่ตามตัวกรอง · แผนกละชุด</MkNote>
                  <MkRow>ไฟล์แยกแผนก (CSV/Excel)</MkRow>
                  <MkNote>ครบทุกแผนก ไม่ตามตัวกรอง · เป็นชั่วโมง ไม่ใช่เงิน</MkNote>
                </span>
...

  {
    ...
    icon: 'check',
    title: 'อนุมัติขั้นที่สอง — รออนุมัติ OT',
    ...
    Body: () => (
      <ol className="manual-steps">
        <li className="manual-step">
          ...
          <ul>
            <li>
              หน้าตาและวิธีใช้เหมือนคิวของหัวหน้า และ<b>ปุ่มเขียนว่า อนุมัติ เหมือนกันทั้งสองคิว</b> —
              เป็นกิจกรรมเดียวกัน ต่างกันแค่ว่าเป็นลายเซ็นที่เท่าไรของใบ
            </li>
            <li>
              ต่างกันที่มี<b>คอลัมน์สถานะ</b>และช่อง <b>สถานะ</b> บนแถบตัวกรองเพิ่มมา
              เพราะคิวนี้เห็นใบตั้งแต่ขั้นหัวหน้า — แถวที่ยังเป็น <b>รอหัวหน้า</b> เปิดอ่านได้
              แต่ยังกดไม่ได้ และจะเข้าคิวนี้เองเมื่อหัวหน้าเซ็นแล้ว
            </li>
            <li>
              <b>แถว รอหัวหน้า ยังวาดปุ่มคู่นั้นไว้ แต่เป็นสีเทากดไม่ได้</b> —
              เพราะแถวนั้นกำลังจะได้ปุ่มคู่นี้จริงบนจอเดียวกันนี้ · ส่วนแถวที่ไม่ใช่ของคุณเลยเป็น<b>ขีด —</b>
              ชี้ค้างที่ปุ่มเทาหรือที่ขีดแล้วมีคำอธิบายขึ้นมา
            </li>
            <li>ติ๊กหลายแถวแล้วอนุมัติทีเดียวได้เหมือนกัน</li>
          </ul>
          <Shot
            alt="คิวรออนุมัติ OT ของฝ่ายบุคคล หน้าตาเหมือนคิวของหัวหน้า และมีคอลัมน์สถานะเพิ่มมาให้เห็นว่าแต่ละใบอยู่ขั้นไหน แถวที่ยังรอหัวหน้าวาดปุ่มอนุมัติและไม่อนุมัติไว้เป็นสีเทากดไม่ได้"
              ...
              <Desk title="รออนุมัติ OT" nav={<MkRow on badge="8">รออนุมัติ OT</MkRow>}>
                ...
                <span className="mk-headrow">
                  ...
                  <span className="mk-acts">
                    <MkChip tone="wait">รอหัวหน้า</MkChip>
                    <MkIconBtn icon="tick" tone="off" />
                    <MkIconBtn icon="cross" tone="off" />
                  </span>
                </span>
                <MkNote>ยังไม่ถึงขั้นของคุณ — รอหัวหน้าแผนกเซ็นก่อน</MkNote>
                <MkBtn>✓ อนุมัติทั้งหมดที่เลือก (2 รายการ)</MkBtn>
              </Desk>
            )}
            phone={(
...

  {
    ...
    Body: () => (
      <ol className="manual-steps">
        ...
        <li className="manual-step">
          <p>
            ทางเข้าอยู่ที่ <b>ตรวจสอบประจำเดือน</b> — หาคนที่ต้องการแล้ว<b>กดที่แถวของคนนั้น</b>
            {' '}(ไม่ใช่ปุ่มท้ายแถว ซึ่งเป็นปุ่มพิมพ์) หน้าที่เปิดมาชื่อ <b>รายการ OT — ชื่อคนนั้น</b>
          ...
          <ul>
            ...
            {/* ── งวดที่ปิดแล้ว — WHAT HR SEES THAT NOBODY ELSE DOES ──────
                They are not stopped and never will be; this says what the two
                extra things on the screen mean, so neither reads as a refusal
                that failed. */}
            <li>
              <b>ถ้าใบนั้นอยู่ในงวดที่พ้นวันตัดแล้ว</b> จะมี<b>แถบเตือนสีเหลือง</b>
              อยู่บนฟอร์ม และตอนกดบันทึกจะมี<b>กล่องยืนยัน</b>คั่นอีกชั้นหนึ่ง ·
              ทั้งสองอย่างเป็นการ<b>บอก ไม่ใช่การห้าม</b> — พนักงานแก้ใบนั้นเองไม่ได้
              แล้ว การแก้ของคุณจึงเป็นการทำแทน · ฝ่ายบุคคลและผู้ดูแลระบบไม่ติดวันตัด
              ไม่ว่างวดจะเก่าแค่ไหน
            </li>
            <li>
              <b>การตัดสินคำขอถอนของงวดที่พ้นวันตัดแล้ว บังคับกรอกเหตุผล</b> —
              บนการ์ด <b>คำขอถอนใบที่อนุมัติแล้ว</b> หัวหน้าจะเห็นปุ่มสองปุ่มเป็น
              <b>สีเทากดไม่ได้</b> พร้อมบรรทัดบอกว่างวดปิดแล้ว ส่วนคุณยังกดได้ · กล่อง
              ที่เปิดมาจะมีช่อง <b>เหตุผลที่ตัดสินหลังงวดปิด *</b> เพิ่มมา และบันทึกลง
              ในใบนั้นคู่กับผลการตัดสิน · ถ้ากด <b>อนุมัติให้ถอนทั้งหมด</b> กรอกครั้ง
              เดียว ระบบบันทึกลงทุกใบในชุดที่งวดปิดแล้ว · <b>ใบในงวดที่ยังเปิดอยู่
              ไม่มีช่องนี้</b> ทุกอย่างเหมือนเดิม
            </li>
          </ul>
          <Shot
            alt="ทางเข้าแก้ใบย้อนหลัง กดที่แถวของคนนั้นในตรวจสอบประจำเดือน แล้วเปิดหน้ารายการ OT ของคนนั้น กดแก้ไขที่ใบที่ต้องการ ฟอร์มที่เปิดมามีช่องเหตุผลการแก้ไขที่บังคับกรอก"
            caption="ชื่อและวันที่ในภาพเป็นตัวอย่าง — ปุ่มบันทึกจะกดไม่ได้จนกว่าช่องเหตุผลจะมีข้อความ"
            desk={(
              <Desk title="ตรวจสอบประจำเดือน" nav={<MkRow on>ตรวจสอบประจำเดือน</MkRow>}>
                <span className="mk-headrow">
                  <MkRow pin="›">สมชาย ใจดี · PM-0620</MkRow>
                  <span className="mk-acts"><MkNote>กดที่แถว</MkNote></span>
                </span>
                <span className="mk-headrow">
            ...
            phone={(
              <Phone title="ตรวจสอบประจำเดือน" bar={<MkSlot icon="chart" label="รายงาน" on />}>
                <MkRow badge="›">สมชาย ใจดี · PM-0620</MkRow>
                <MkNote>กดที่แถวเพื่อเปิดรายการของคนนั้น</MkNote>
                <span className="mk-dlg">
                  <span className="mk-dlg-h">แก้ไขรายละเอียด (ฝ่ายบุคคล)</span>
          ...
          <Shot
            ...
            desk={(
              <Desk title="บันทึกและประวัติ OT" nav={<MkRow on>บันทึกและประวัติ OT</MkRow>}>
                ...
                <MkNote>ฝ่ายบุคคลแก้ตัวเลขให้ได้จาก ตรวจสอบประจำเดือน → กดที่แถวของคนนั้น</MkNote>
              </Desk>
            )}
            phone={(
              <Phone title="บันทึกและประวัติ OT" bar={<MkSlot icon="clock" label="ประวัติ OT" on />}>
