...
import { api, hours, currentPeriod, periodLabel, BUCKETS } from '../api.js';
import { Alert, Empty } from './common.jsx';
import PrintForm from './PrintForm.jsx';

/** HR's monthly review (§2): one row per employee, then export or print. */
                    ...
                    <tr key={row.employee._id}>
                      ...
                      <td>
                        {row.cap.capHours == null ? (
                          ...
                          <span style={{ color: row.cap.exceeded ? 'var(--red)' : 'inherit' }}>
