...
- `npm test` — **2391 tests, all green**, about 3.3 s, measured 2026-09-09 across 132
  files. It read **"2387 … across 132"** until the เกินเพดาน red and the วันเกิด strip
