...
and the engine know nothing about Next.js, so the whole suite — **2374 tests
...
- `npm test` — **2374 tests, all green**, about 3.4 s, measured 2026-09-08 across 131
  files. It read **"2366 … across 130"** until แถบช่องติ๊กบนฟอร์มบันทึก OT was cut to
