...
test/                     133 files, run by `npm test`. Six named below as a
...
- `npm test` — **2407 tests**, about 7 s, measured 2026-09-09 across 133
