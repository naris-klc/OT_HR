...
test/                     121 files, run by `npm test`. Six named below as a
...
- `npm test` — **2070/2070 pass in about 3 s**, measured 2026-09-02 across 121
  files. **The newest is `test/screenTablePrint.test.js`** — รายงาน OT ฝ่ายบัญชี
  survives Ctrl+P as well as its own พิมพ์ button. (It read "2060/2060 … across
  120 files. The newest is `test/oneRowPerDate.test.js`" until that afternoon.)
