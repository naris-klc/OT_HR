...
and the engine know nothing about Next.js, so the whole suite — **2375 tests
...
- `npm test` — **2375 tests, all green**, about 3.1 s, measured 2026-09-09 across 131
  files. It read **"2380 … across 131"** until the grey `ไม่ได้สแกนเข้า OT` chip was
