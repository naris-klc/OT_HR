...
test/                     135 files, run by `npm test`. Six named below as a
...
- `npm test` — **2449 tests**, about 7 s, measured 2026-09-10 across 135
  files. It read **"2378 tests … across 131"** until ot-hardening-and-slips was
