...
and the engine know nothing about Next.js, so the whole suite — **2599 tests
...
- `npm test` — **2599 tests**, about 4 s, measured 2026-09-11 across 144
  files, all green. It read **"2598 tests … across 144"** until the วันเกิด
