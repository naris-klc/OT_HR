...
and the engine know nothing about Next.js, so the whole suite — **2462 tests
...
- `npm test` — **2462 tests**, about 7 s, measured 2026-09-10 across 136
  files. It read **"2449 tests … across 135"** until the browser's own bubble
