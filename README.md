...
- **ช่อง เวลาเริ่ม กับ เวลาสิ้นสุด ในแผง แก้ไขชั่วโมง กลับมาอยู่บรรทัดเดียวกัน**
  ...
  *ล็อก 08:00–17:00 น. แก้เวลาไม่ได้* ทำให้สองช่องสูงไม่เท่ากัน และ `.row` ของทั้งแอป
  ...
  ป้ายตรงกัน ช่องตรงกัน และบรรทัดล็อกห้อยอยู่ใต้ช่องที่มันพูดถึง · ตรึงไว้ใน
  `quickEditOvernight` พร้อมกฎ `.row` ที่ร่วมกัน เพราะข้อยกเว้นนี้มีความหมายเฉพาะตอนที่
  กฎร่วมยังไม่ตรงกับมัน
