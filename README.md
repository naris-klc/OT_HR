...
**เดินจริงแล้วบนเครื่อง Linux เครื่องหนึ่ง ตั้งแต่ 2026-09-09** และตั้งแต่วันเดียวกัน
เครื่องนั้นมี URL สาธารณะผ่านอุโมงค์ Cloudflare ด้วย ซึ่งเป็น profile ที่ต้องสั่ง
เปิดเอง ไม่ใช่ค่าเริ่มต้นของ deploy — รายละเอียดทั้งหมดอยู่ใน
[docs/docker.md](docs/docker.md) *(ย่อหน้านี้เคยอ่านว่า "ณ 2026-09-09 ยังไม่มี
