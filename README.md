...
and the engine know nothing about Next.js, so the whole suite — **2648 tests
...
- **คอลัมน์ `รายการ` ออกแบบใหม่ — จำนวนใบทั้งเดือน แล้วเขียนเฉพาะส่วนที่ค้าง**
  ...
  **ตัวเลขจึงบวกกันได้โดยโครงสร้าง** ไม่ใช่โดยบังเอิญจนกว่าจะมีคนหรี่ตัวกรอง
  ...
  (`หัวหน้า 1 · HR 2` ราว 90px ในคอลัมน์ 96px) และบรรทัดนั้นสั่ง `nowrap` ไว้ —
...
- `npm test` — **2648 tests**, about 4 s, measured 2026-09-11 across 146
