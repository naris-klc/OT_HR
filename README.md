...
and the engine know nothing about Next.js, so the whole suite — **2647 tests
...
- `npm test` — **2647 tests**, about 4 s, measured 2026-09-11 across 146
  files, all green. It read **"2634 tests … across 146"** until ทะเบียนพนักงาน
