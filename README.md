...
- `npm test` — **2387 tests, all green**, about 3.3 s, measured 2026-09-09 across 132
  files. It read **"2377 … across 131"** until the date cell on คิวรออนุมัติ gained
