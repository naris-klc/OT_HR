...
test/                     130 files, run by `npm test`. Six named below as a
...
and the engine know nothing about Next.js, so the whole suite — **2366 tests
across 130 files**, measured 2026-09-08 — runs with plain `node --test`, no
...
- `npm test` — **2366 tests, all green**, about 3.2 s, measured 2026-09-08 across 130
  files. It read **"2352 … across 129"** until ประวัติการแก้ทะเบียน folded each
