...
- **แท็ก ขอล่วงหน้า / ขอย้อนหลัง ใต้วันที่บนคิวรออนุมัติ** — 2026-09-09,
  ...
  *วันเดียวกัน* และไม่ขึ้นแท็กเลย ซึ่งคือแถวที่ตัวเลขนี้มีไว้เพื่อ · `today()` คือที่เดียวในระบบที่แปลง
  ...
  เหมือนเดิม) · `ขอย้อนหลัง 365 วัน` วัดบนแอปที่ build แล้วได้ 111.3px และแท็กที่ตกบรรทัด
...
- `npm test` — **2398 tests, all green**, about 3.3 s, measured 2026-09-09 across 132
  files. It read **"2391 … across 132"** until ช่องลงชื่อหัวหน้างาน started naming the
