...
- `npm test` — **2463 tests**, about 7 s, measured 2026-09-10 across 136
  files. It read **"2462 tests … across 136"** until the phone's dropdown
  became the bar menu's own sheet — `queueDropdown`, one case, no new file, and
  the round is a stylesheet's rather than a component's. Before that it read
  **"2449 tests … across 135"** until the browser's own bubble
  was taken off ฟอร์มบันทึก OT — `otFormBlankDescription`, eleven cases, one new
  file. Before that it read **"2378 tests … across 131"** until ot-hardening-and-slips was
