...
| แจ้งเตือน “อนุมัติชั้นเดียว” | อยู่บนสุดของการ์ด ใต้แถบนโยบาย เหนือช่องค้นหา · พับไว้ตั้งต้น กด `ดูรายละเอียด` / `ซ่อนรายละเอียด` · ✕ ปิดได้ และกลับมาเมื่อเปลี่ยนเดือนหรือสถานะที่นับ | `components/HrView.jsx` · `components/common.jsx` (`Alert`) | `hrMonthCards` | ✅ เดินบนสำเนาฐาน 2026-08-25 — ครบทั้งห้าสถานะที่ 360×780 และที่ 1440px |
