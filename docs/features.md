...
| แถบแจ้งเตือนของเดือน | ยุบกล่องเตือนบนสุดทั้งหมดเหลือแถบเดียว นับและระบุชื่อแต่ละข้อความ · สีตามข้อความที่แรงที่สุด · กาง/พับด้วย `ดูรายละเอียด ▼` `ซ่อน ▲` · ✕ ปิดจนกว่าจะ refresh แล้วเหลือบรรทัด `แสดงแจ้งเตือนของเดือนนี้ (n)` | `components/HrView.jsx` (`MonthAlerts`) · `components/PolicyVersion.jsx` (`policyVersionNotice`) | `hrMonthCards` | ✅ เดินบนสำเนาฐาน 2026-08-25 — 360×780 พับ 127px กาง 466px ปิดแล้ว 0px · ป้ายบนแถวอยู่ครบทุกสถานะ |
