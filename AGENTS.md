...
## เขียนให้กระชับ — Say it once, in plain words

**ทุกคำอธิบายและทุกคำตอบ ทั้งในแชตและในเอกสาร เขียนให้กระชับ ได้ใจความ ตัด
คำอธิบายที่ไม่จำเป็นออก และใช้ภาษาที่เข้าใจง่าย** สั่งไว้ 2026-09-14

ข้อสรุปมาก่อน เหตุผลตามมาเท่าที่ต้องใช้ตัดสินใจ · ตัดอารัมภบท ตัดย่อหน้าที่พูด
สิ่งเดียวกันสองรอบ ตัดเหตุผลประกอบที่ลบแล้วคนอ่านยังตัดสินใจถูกเหมือนเดิม ·
ตารางหรือบุลเล็ตแทนย่อหน้ายาวเมื่อทำได้

**กระชับคือตัดคำ ไม่ใช่ตัดเนื้อหา** ของที่ห้ามตัด: เหตุผลว่า*ทำไม*ถึงตัดสินใจ
แบบนั้น · ข้อมูลที่คนอ่านต้องใช้ตัดสินใจ · คำเตือนเรื่องของที่พังได้ · สิ่งที่ยัง
ไม่ได้ถามผู้ใช้ · ไฟล์นี้และธรรมเนียมคอมมิตข้างล่างยืนอยู่บนเหตุผลที่เขียนไว้
ตอนนั้น ซึ่งเป็นสิ่งเดียวที่ซ่อมทีหลังไม่ได้
