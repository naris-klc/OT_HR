 ...
 *
 * `direction` is `'ahead'` — the work had not happened yet, ขอล่วงหน้า — or
 * `'back'`, it already had, ขอย้อนหลัง. `days` is always positive: the sign
 * lives in the direction, so no caller can print `ขอย้อนหลัง -3 วัน`.
 *
