 ...
 * and priced exactly as they were. That is why the form shows the box anyway
 * when it is ALREADY TICKED — a request filed before this rule, or corrected by
 * ฝ่ายบุคคล, must stay untickable-back rather than become a flag nobody on the
 * screen can reach. See `mayTickFlatDaily` where OtForm draws it.
 */
