 ...
 *
 * SO THE RULE IS TWO STEPS, IN ORDER, AND THE ORDER IS THE WHOLE OF IT:
 *
 ...
 *   2. `approve_hr` or `submit_hr_verified` — but ONLY where step 1 never
 *      happened. These are the rows that reach อนุมัติ without a หัวหน้า
 ...
 *
 *   - a request nobody has approved yet — still at รอหัวหน้า or รอ HR. No
 *     approval row of any kind, and an unsigned box is what an unsigned form
 *     looks like;
 ...
 * name that prints for step 2 is an account rather than a person, which is true
