...
/**
 * Who may stand in. All three sign things already; nobody else in the roster
 * does.
 *
 * ผู้ดูแลระบบ joined the list on 2026-08-24 — it was `['manager', 'hr']`, which
 ...
 */
export const DELEGATE_ROLES = Object.freeze(['manager', 'hr', 'admin']);
...
export function approvalPermission({
  ...
  if (entry.status === 'pending_mgr') {
     ...
     * `authorizeReplay`, เปิดงวด, เปลี่ยนรหัสพนักงาน — is refused without one,
