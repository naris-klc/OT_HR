...
const RULES = {
  ...
  /** วันเกิด 29 ก.พ. ← กฎวันหยุดวันเกิด. */
  birthdayLeapFallback(policy) {
    ...
    return {
      text: 'ไม่มีผลกับค่าที่ตั้งอยู่ตอนนี้ — กฎ “วันเกิดพนักงานเป็นวันหยุดของคนนั้น” ปิดอยู่ '
        + 'จึงไม่มีวันหยุดวันเกิดให้ตัดสินว่าตกวันไหน · จะมีผลเมื่อเปิดกฎนั้น',
      causes: ['birthdayHolidayEnabled'],
    };
  },

  /** ฝ่ายบุคคลบันทึก OT ให้จากรายการวันเกิด ← กฎวันหยุดวันเกิด. */
