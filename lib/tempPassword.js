 ...
 * on the model — a notice the client shell draws until it is, since the screen
 * that used to enforce it was deleted on 2026-09-04) and that is not meant to
 * be the account's password for long, that is the right trade. It is
