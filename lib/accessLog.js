...
const ACTIONS = [
  ...
  ['GET', '/birthday/queue', 'ดูคิวตรวจสวัสดิการวันเกิด'],
  ['POST', '/birthday/checks', 'บันทึกผลตรวจสวัสดิการวันเกิด'],
  ['POST', '/birthday/entries', 'ยื่นใบสวัสดิการวันเกิด'],
  ...
  ['GET', '/reports/birthday-check/:period', 'ดูรายงานตรวจสวัสดิการวันเกิด'],
];
